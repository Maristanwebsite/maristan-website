...
export const IslamicPsychology = ({ data }) => {
	return (
		<section className="px-4 py-[60px] lg:py-[75px]">
			<div
			...
			>
				<div className="px-4 sm:py-6 pl-[45px] lg:pl-0">
					<div className="lg:p-[75px] pb-3 pt-8 sm:pt-[30px] md:pt-[55px] sm:pb-0 lg:pt-[75px] lg:py-[40px] grid lg:grid-cols-2 lg:gap-x-[75px]">
						<div>
							<div>
								<div>
									<div>
