      ...
      {data?.map((item, index) => (
        <div key={index} className="">
            <Link href={`/projects/${item?.attributes?.slug}`}>
              <p className=" text-[14px] py-[12px] px-[12px] rounded-[5px] hover:bg-[#F7F3F0] text-[#2C2C2C] leading-[24px] ff-overpass font-[400] uppercase hover:text-[#8F1A1D] transition-all duration-300 mx-auto w-full ">
