		...
		<>
			{data ? (
				<section className={`px-4 ${home && 'pb-[75px]'} `}>
					...
					>
						<div className="px-4 pl-[45px] lg:pl-4">
									...
									<div>
										<div>
											...
											<div className="flex flex-col sm:flex-row sm:gap-x-[10px] gap-y-[10px] lg:gap-y-0 ff-overpass">
												<d className="py-[16px] px-[24px] rounded-[8px] border border-1px bg-[#FFFFFF] border-[#FFFFFF] hover:bg-[#F9FAFB] duration-300 transition-all">
													<Link
														href={data?.cta[0]?.link}
														target="_blank"
														className="w-full flex items-center gap-[16px] text-[#2C2C2C]  font-[600] text-[16px] leading-[20px] uppercase justify-center"
													>
														<Heart stroke="#2C2C2C" />
												...
												<button className="py-[16px] px-[24px]  rounded-[8px] border border-1px border-[#FFFFFF]">
													<a
														...
														target="_blank"
														className="flex items-center gap-[16px] text-[#FFFFFF] font-[600] text-[16px] leading-[20px] uppercase justify-center"
													>
														<User />
														<p>{data?.cta[1]?.name}</p>
													</a>
