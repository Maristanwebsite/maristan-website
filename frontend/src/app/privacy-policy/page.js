...
export default async function PrivacyPolicy() {
    return (
        <section className="py-[75px]">
            <div className="max-w-[1440px] mx-auto rounded-[32px] cus-background p-[40px]">
                <h2 className='mb-[16px] text-[#2C2C2C] text-[40px] leading-[47px] ff-convergence'>Privacy Policy</h2>
                <p>
                ...
                <h2 className="mt-[40px] text-[#2C2C2C] text-[40px] leading-[47px] ff-convergence mb-[16px]">What Data We Collect</h2>
